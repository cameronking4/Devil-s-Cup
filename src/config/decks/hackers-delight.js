...
export default {
  ...
  cards: [
    ...generalDeck,
 () => `Drink ${getRandomSip()} if you ran for the bus and the driver left your ass.`,
 ...
 () => `Drink if you made a Tinder for Cardi`, 
 ...
 () => `If you haven't gone to Wilson today, take ${getRandomSip()} sips.`,
...
() => `Drink if you live(d) in Swift or Bell Tower, you privileged fuck`,
...
(players) => {
 ...
 (players) => {
      ...
      return `${player}, Congrats on making honor council. You now control the Community Standard. Create 1 new rule or change a previous rule. Whoever breaks it drinks ${getRandomSip()}.`
	   ...
	   (players) => {
      const player = getRandomPlayer(players)
      return `${player}, you're the cool RA who goes out. Others in the group aren't allowed to answer any of your questions for the rest of the game. If you successfully get a response, they drink.`
    },	
